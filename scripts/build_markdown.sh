...
# Partial derivative, indicating fragment work.
FRAGMENT="∂"
...
do
   # Basename of source. If `src` is `foo.bar.baz`, `jobname` is `foo`.
...
#echo "full_name_src=${full_name_src}"
#echo "bare_name_common=${bare_name_common}"
#echo "full_name_bin=${full_name_bin}"
